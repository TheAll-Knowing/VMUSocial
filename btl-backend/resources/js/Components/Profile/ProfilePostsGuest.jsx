...
import ProfilePostGuest from "@/Components/Profile/ProfilePostGuest.jsx";
export default function ProfilePostsGuest({posts, followers, following}) {
    return(
        <>
