...
export default function Inbox({users, auth}) {
    return (
        <>
            <div className="flex">
                ...
                <InboxLayout auth={auth} users={users}>
                    <div className="flex flex-col justify-center h-full">
                        ...
                        <div className="px-4 pt-5 flex justify-center">
                            <button className="h-8 w-auto px-4 font-semibold rounded-lg text-sm text-white bg-[#0095F6] hover:bg-[#1877F2]">Send message</button>
                        </div>
                    </div>
                </InboxLayout>
            </div>
